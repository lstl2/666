...
<div id="header">
	<h1 id="logo">
		<a target="_blank" href="http://www.lstl.tk">蓝色天狼附件上传下载管理系统</a>
	</h1>
</div>
	...
	<div class="col-sub">
		<ul id="main-menu">
			...
			<li id="help8">
		  		<span>
		  			<i class="icon"></i>
		  			<a href="http://www.lstl.tk" target="_blank">蓝色天狼主页</a>
		  		</span>
		  	</li>
		</ul>
	</div>
...
<div id="footer">
	CopyRight ©2018 <a href="http://www.lstl.tk" target="_blank">蓝色天狼</a> All Rights Reserved.
</div>
